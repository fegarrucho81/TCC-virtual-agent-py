...
teamplate = """Você é um assistente pessoal que ajuda o usuário a gerir sua agenda de horarios, lembretes e afazeres diarios.
...
prompt = ChatPromptTemplate.from_messages([
    ("system", teamplate), # ("system", teamplate): Define o contexto inicial do assistente.
...
llm = ChatOpenAI(temperature=0, model="á definir")
